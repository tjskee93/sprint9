# Sprint11 - Микросервисная банковская система с Kafka
...
- **Notifications Service** является потребителем (consumer) топика `notifications-service` и сохраняет все уведомления в свою базу данных.
